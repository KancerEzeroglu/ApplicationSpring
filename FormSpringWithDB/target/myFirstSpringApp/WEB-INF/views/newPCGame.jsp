							...
							<form class="form-horizontal" role="form" id="newPCGameForm"
								...
								<div class="form-group">
									<label class="col-md-2 control-label" for="cdn_url">CDN
										Url</label>
									<div class="col-md-6">
										<input class="form-control" id="cdn_url" path="cdn_url"
											name="cdn_url" placeholder="Please enter CDN Url"></input>
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-2 control-label" for="bgn_url">Background
										Image</label>
									<div class="col-md-6">
										<input class="form-control" id="bgn_url" path="bgn_url"
											name="bgn_url"
								...
								<div class="form-group">
									<label class="col-md-2 control-label" for="tml_url">Thumbnail
										Image</label>
									<div class="col-md-6">
										<input class="form-control" id="tml_url" path="tml_url"
											name="tml_url" placeholder="Please enter Thumbnail Image Url"></input>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-6" id="colorArea">
										<input class="color" id="color" path="color" name="color"
											value="ffffff">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-6 bs-example bs-example-tabs"
										...
										<div id="langTabsContent" class="tab-content">
											<div role="tabpanel" class="tab-pane fade active in"
												...
												<textarea rows="3" class="form-control" id="turkishArea"
													name="turkishArea" path="turkishArea">Turkish text here</textarea>
											</div>
											<div role="tabpanel" class="tab-pane fade" id="english"
												aria-labelledby="english-tab">
												<textarea rows="3" class="form-control" id="englishArea"
													name="englishArea" path="englishArea">English text here</textarea>
											</div>
											<div role="tabpanel" class="tab-pane fade" id="arabic"
												aria-labelledby="arabic-tab">
												<textarea rows="3" class="form-control" id="arabicArea"
													name="arabicArea" path="arabicArea">Arabic text here</textarea>
											</div>
										</div>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-6">
										<input class="form-control" id="video" name="video"
											path="video" placeholder="Please enter video url"></input>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-6 checkbox checkbox-nice">
										<input type="checkbox" id="test" checked="checked" path="test"
											name="test"> <label for="test"></label>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="controls col-md-6">
										<div class="entry input-group col-md-6">
											<input class="form-control" id="fields" name="fields"
												path="fields" type="text" placeholder="Type something" /> <span
								...
								<div class="form-group">
									<label class="col-md-2 control-label" for="viewOrder">View
										Order</label>
									<div class="col-md-6">
										<input class="form-control" id="viewOrder" name="viewOrder"
											path="viewOrder" placeholder="2"></input>
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-2 control-label" for="insDic">Install
										Directory</label>
									<div class="col-md-6">
										<input class="form-control" id="insDic" name="insDic" path=""
											insDic placeholder="C:/games"></input>
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-2 control-label" for="regKey">Registery
										Key</label>
									<div class="col-md-6">
										<input class="form-control" id="regKey" name="regKey"
											path="regKey" placeholder="Software\Softnyx\"></input>
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-2 control-label" for="laExPath">Launch
										Exe Path</label>
									<div class="col-md-6">
										<input class="form-control" id="laExPath" name="laExPath"
											path="laExPath" placeholder="2"></input>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-6">
										<input class="form-control" id="twitter" name="twitter"
											path="twitter" placeholder="2"></input>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-6">
										<input class="form-control" id="facebook" name="facebook"
											path="facebook" placeholder="2"></input>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-6">
										<input class="form-control" id="youtube" name="youtube"
											path="youtube" placeholder="2"></input>
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-2 control-label" for="google">Google+</label>
									<div class="col-md-6">
										<input class="form-control" id="google" name="google"
											path="google" placeholder="2"></input>
									</div>
								</div>
								<div class="col-lg-10">
									<div class="pull-right">
										<button type="submit" class="btn btn-success"
											id="createPCGame">Create</button>
									</div>
								</div>
